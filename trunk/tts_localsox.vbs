...
objShell.Run "sox.exe " & strFileName & " " & "trimmedtemp.wav" & " " & "silence 1 0.01 0.5% reverse silence 1 0.01 0.5% reverse", 0, True
...
if Len(AddSilentMsec)>0 Then
	...
	objShell.Run "sox.exe " & strFileName & " " & "trimmedtemp.wav" & " " & " pad 0 "& SilentSec &" reverse reverse", 0, True
	filesys.DeleteFile strFileName
	filesys.MoveFile "trimmedtemp.wav", strFileName
	'****************************************************************************************************************************
End if
...
if CodecFlag="e" then
  ...
  objShell.Run "sox.exe " & strFileName & " --norm -c 1 -t .wav -b 8 -r 16000  tempconvert.wav", 0, True
  filesys.DeleteFile strFileName
  filesys.MoveFile "tempconvert.wav", strFileName
  objShell.Run "sox.exe " & strFileName & " tempconvert.wav  gain -6 treble +3 ", 0, True
  filesys.DeleteFile strFileName
  filesys.MoveFile "tempconvert.wav", strFileName
end if
...
if CodecFlag="high" then
  ...
  objShell.Run "sox.exe " & strFileName & " --norm -c 1 -t .wav -b 16 -r 22000  tempconvert.wav", 0, True
  filesys.DeleteFile strFileName
  filesys.MoveFile "tempconvert.wav", strFileName
end if

if CodecFlag="ad4" then
	objShell.Run "sox.exe " & strFileName & " --norm -c 1  -t .wav -b 16 -r 32000  tempconvert.wav", 0, True
	filesys.DeleteFile strFileName
	filesys.MoveFile "tempconvert.wav", strFileName
